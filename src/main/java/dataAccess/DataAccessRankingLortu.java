 ...
 */
public class DataAccessRankingLortu  {
	...
	ConfigXML c=ConfigXML.getInstance();
     ...
     public DataAccessRankingLortu(boolean initializeMode)  {
	...
	//Tuvimos que añadir este método abajo para que no dé error en el método de inicialización
